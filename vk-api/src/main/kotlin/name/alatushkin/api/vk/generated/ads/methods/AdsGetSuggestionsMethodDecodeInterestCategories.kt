 ...
 */
class AdsGetSuggestionsMethodDecodeInterestCategories() : VkMethod<Array<TargSuggestions>>(
    "ads.getSuggestions",
    ...
    fun setIds(ids: String): AdsGetSuggestionsMethodDecodeInterestCategories {
        this.ids = ids
        return this
    }

    fun setLang(lang: Lang): AdsGetSuggestionsMethodDecodeInterestCategories {
        this.lang = lang
        return this
    }

    override val classRef = AdsGetSuggestionsMethodDecodeInterestCategories.classRef
