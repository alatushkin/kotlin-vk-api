 ...
 */
class AdsGetSuggestionsMethodDecodeStreets() : VkMethod<Array<TargSuggestionsCities>>(
    "ads.getSuggestions",
    ...
    fun setIds(ids: String): AdsGetSuggestionsMethodDecodeStreets {
        this.ids = ids
        return this
    }

    fun setLang(lang: Lang): AdsGetSuggestionsMethodDecodeStreets {
        this.lang = lang
        return this
    }

    override val classRef = AdsGetSuggestionsMethodDecodeStreets.classRef
