 ...
 */
class AdsGetSuggestionsMethodDecodeUserOs() : VkMethod<Array<TargSuggestions>>(
    "ads.getSuggestions",
    mutableMapOf("section" to "user_os")
) {
    ...
    fun setIds(ids: String): AdsGetSuggestionsMethodDecodeUserOs {
        this.ids = ids
        return this
    }

    fun setLang(lang: Lang): AdsGetSuggestionsMethodDecodeUserOs {
        this.lang = lang
        return this
    }

    override val classRef = AdsGetSuggestionsMethodDecodeUserOs.classRef
