 ...
 */
class AdsGetSuggestionsMethodUserDevices() : VkMethod<Array<TargSuggestions>>(
    "ads.getSuggestions",
    ...
    fun setQ(q: String): AdsGetSuggestionsMethodUserDevices {
        this.q = q
        return this
    }

    fun setLang(lang: Lang): AdsGetSuggestionsMethodUserDevices {
        this.lang = lang
        return this
    }

    override val classRef = AdsGetSuggestionsMethodUserDevices.classRef
