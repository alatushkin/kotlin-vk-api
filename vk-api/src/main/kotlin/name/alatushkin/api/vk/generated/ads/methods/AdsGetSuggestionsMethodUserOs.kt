 ...
 */
class AdsGetSuggestionsMethodUserOs() : VkMethod<Array<TargSuggestions>>(
    "ads.getSuggestions",
    ...
    fun setQ(q: String): AdsGetSuggestionsMethodUserOs {
        this.q = q
        return this
    }

    fun setLang(lang: Lang): AdsGetSuggestionsMethodUserOs {
        this.lang = lang
        return this
    }

    override val classRef = AdsGetSuggestionsMethodUserOs.classRef
