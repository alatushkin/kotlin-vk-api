 ...
 *  @property [keep_forward_messages] '1' — to keep forwarded, messages.
 *  @property [keep_snippets] '1' — to keep attached snippets.
 *  @property [group_id] Group ID (for group messages with user access token)
 */
class MessagesEditMethod() : VkMethod<Boolean>(
    "messages.edit",
    HashMap()
) {
    ...
    override val classRef = MessagesEditMethod.classRef
