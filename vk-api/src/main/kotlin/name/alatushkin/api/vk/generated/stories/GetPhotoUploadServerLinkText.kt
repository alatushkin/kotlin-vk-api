...
enum class GetPhotoUploadServerLinkText(@JsonValue val jsonValue: String) {
    TO_STORE("to_store"), VOTE("vote"), MORE("more"),
    BOOK("book"), ORDER("order"),
    ENROLL("enroll"), FILL("fill"),
    SIGNUP("signup"), BUY("buy"),
    TICKET("ticket"), WRITE("write"),
    OPEN("open"), LEARN_MORE("learn_more"),
    VIEW("view"), GO_TO("go_to"),
    CONTACT("contact"), WATCH("watch"),
    PLAY("play"), INSTALL("install"),
    READ("read");
